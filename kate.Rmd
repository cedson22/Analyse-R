...
output:
  rmdformats::readthedown:
    ...
    use_bookdown: true
---
##**Note**  si *use_bookdown est true** on peut utiliser le backage Bookdown pour la rédaction de notre document.
Il permet entre autres, les références croisées et la numérotation des équations.
